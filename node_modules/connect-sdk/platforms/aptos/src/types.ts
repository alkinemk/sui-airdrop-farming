...
import { SUI_SEPARATOR } from "@wormhole-foundation/connect-sdk-sui/src/constants";
 ...
 */
export const coalesceModuleAddress = (str: string): string => str.split(SUI_SEPARATOR)[0]!;
