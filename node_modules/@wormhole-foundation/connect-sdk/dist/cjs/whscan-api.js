...
exports.getTxsByAddress = exports.getVaaByTxHashWithRetry = exports.getVaaByTxHash = exports.getRelayStatusWithRetry = exports.getRelayStatus = exports.getTransactionStatusWithRetry = exports.getTransactionStatus = exports.getVaaWithRetry = exports.getVaa = exports.getVaaBytesWithRetry = exports.getVaaBytes = exports.WHSCAN_RETRY_INTERVAL = void 0;
...
async function getVaaBytesWithRetry(apiUrl, whm, timeout) {
    ...
    return await (0, tasks_1.retry)(task, exports.WHSCAN_RETRY_INTERVAL, timeout, "Wormholescan:GetVaaBytes");
}
...
async function getTransactionStatusWithRetry(rpcUrl, whm, timeout) {
    ...
    return await (0, tasks_1.retry)(task, exports.WHSCAN_RETRY_INTERVAL, timeout, "Wormholescan:GetTransactionStatus");
}
...
async function getRelayStatusWithRetry(rpcUrl, txid, timeout) {
    ...
    return (0, tasks_1.retry)(task, exports.WHSCAN_RETRY_INTERVAL, timeout, "Wormholescan:GetRelayStatus");
}
...
async function getVaaByTxHashWithRetry(rpcUrl, txid, decodeAs, timeout) {
    ...
    const vaa = await (0, tasks_1.retry)(task, exports.WHSCAN_RETRY_INTERVAL, timeout, "Wormholescan:GetVaaByTxHash");
    if (!vaa)
        return null;
