...
export type TransferReceipt<AT, SC extends Chain = Chain, DC extends Chain = Chain> = CreatedTransferReceipt<SC, DC> | SourceInitiatedTransferReceipt<SC, DC> | SourceFinalizedTransferReceipt<AT, SC, DC> | AttestedTransferReceipt<AT, SC, DC> | CompletedTransferReceipt<AT, SC, DC>;
