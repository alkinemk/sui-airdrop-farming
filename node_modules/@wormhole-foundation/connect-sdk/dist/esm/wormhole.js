...
export class Wormhole {
    ...
    async circleTransfer(amount, from, to, automatic, payload, nativeGas) {
        ...
        if (!circle.isCircleChain(from.chain) ||
     ...
     * @throws Errors if the VAA is not available after the retries
     */
    async getVaa(wormholeMessageId, decodeAs, timeout = DEFAULT_TASK_TIMEOUT) {
     ...
     * @throws Errors if the VAA is not available after the retries
     */
    async getVaaByTxHash(txid, decodeAs, timeout = DEFAULT_TASK_TIMEOUT) {
     ...
     */
    async getTransactionStatus(wormholeMessageId, timeout = DEFAULT_TASK_TIMEOUT) {
