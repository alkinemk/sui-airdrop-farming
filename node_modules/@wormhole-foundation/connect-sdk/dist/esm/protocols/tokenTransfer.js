import { encoding, toChain as toChainName, } from "@wormhole-foundation/sdk-base";
import { TokenBridge, deserialize, isTokenId, isTokenTransferDetails, isTransactionIdentifier, isWormholeMessageId, serialize, toNative, toUniversal, } from "@wormhole-foundation/sdk-definitions";
import { signSendWait } from "../common";
import { DEFAULT_TASK_TIMEOUT } from "../config";
import { Wormhole } from "../wormhole";
import { TransferState, isAttested, isSourceFinalized, isSourceInitiated, } from "../wormholeTransfer";
export class TokenTransfer {
    ...
    static async destinationOverrides(srcChain, dstChain, transfer) {
        ...
        if (_transfer.to.chain === "Sei") {
            ...
            _transfer.to = Wormhole.chainAddress(_transfer.to.chain, dstChain.config.contracts.translator);
        }
        return _transfer;
    }
    ...
    static async *track(wh, receipt, timeout = DEFAULT_TASK_TIMEOUT, fromChain, toChain) {
