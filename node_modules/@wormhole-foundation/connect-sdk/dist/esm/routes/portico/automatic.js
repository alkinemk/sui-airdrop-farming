import { PorticoBridge, TokenTransfer, TransferState, Wormhole, canonicalAddress, chainToPlatform, contracts, isAttested, isSourceInitiated, isTokenId, resolveWrappedToken, signSendWait, tokens, } from "../..";
    ...
    async validate(params) {
        try {
            ...
            if (quote.destinationToken.amount < 0) {
                throw new Error(`Amount too low for slippage and fee, would result in negative destination amount (${quote.destinationToken.amount})`);
            }
