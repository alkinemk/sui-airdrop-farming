...
exports.displayAmount = exports.normalizeAmount = void 0;
/**
...
function normalizeAmount(amount, decimals) {
    ...
    const [whole, partial] = chunks.length === 0 ? ["0", ""] : chunks.length === 1 ? [chunks[0], ""] : chunks;
 ...
 */
function displayAmount(amount, decimals, displayDecimals) {
