...
function calcItemSize(item, data) {
    switch (item.binary) {
        ...
        case "switch": {
            const [_, layout] = (0, utils_1.findIdLayoutPair)(item, data);
            return item.idSize + calcLayoutSize(layout, data);
        }
    }
}
function calcLayoutSize(layout, data) {
...
exports.calcLayoutSize = calcLayoutSize;
