...
export declare const porticoFlagSetLayout: readonly [{
    ...
    readonly custom: {
        to: (encoded: bigint) => import("@wormhole-foundation/sdk-base").Bitset<readonly ["shouldWrapNative", "shouldUnwrapNative"]>;
        from: (obj: import("@wormhole-foundation/sdk-base").Bitset<readonly ["shouldWrapNative", "shouldUnwrapNative"]>) => bigint;
    };
    readonly name: "flags";
}];
