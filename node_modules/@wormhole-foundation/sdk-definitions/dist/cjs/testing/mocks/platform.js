...
exports.MockPlatform = exports.mockPlatformFactory = void 0;
const __1 = require("../..");
const chain_1 = require("./chain");
const rpc_1 = require("./rpc");
function mockPlatformFactory(platform, config) {
...
// mockPlatformFactory
class MockPlatform extends __1.PlatformContext {
    ...
    getChain(chain) {
        if (chain in this.config)
            return new chain_1.MockChain(chain, this);
