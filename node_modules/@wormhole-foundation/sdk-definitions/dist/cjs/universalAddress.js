...
class UniversalAddress {
    ...
    toNative(chainOrPlatform) {
        return (0, address_1.toNative)(chainOrPlatform, this);
    }
    unwrap() {
        return this.address;
    }
    ...
    static stringToUint8Array(address, format) {
        const decoded = (() => {
            switch (format) {
                ...
                case "algorandAppId":
                    return (0, utils_1.sha512_256)((0, sdk_base_1.serializeLayout)(algorandAppIdLayout, { appId: BigInt(address) }));
                case "sha256":
                    return (0, utils_1.sha256)(address);
            }
        })();
