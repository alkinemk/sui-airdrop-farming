 ...
 */
export async function signSendAndConfirmTransaction(connection, payer, signTransaction, unsignedTransaction, options) {
 ...
 * 4. Confirm transaction.
 */
export async function sendAndConfirmTransactionsWithRetry(connection, signTransaction, payer, unsignedTransactions, maxRetries = 0, options) {
